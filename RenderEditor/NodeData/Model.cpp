...
unsigned int Model::TextureFromFile(const char *path, const string &directory, bool gamma)
{
	...
	if (data)
	{
		...
		_func->glTexImage2D(GL_TEXTURE_2D, 0, format, width, height, 0, format, GL_UNSIGNED_BYTE, data);
...
Model::Model(string const & path, QOpenGLFunctions_3_3_Core* func, bool gamma)
...
void Model::Draw(std::shared_ptr<QOpenGLShaderProgram> shader)
{
...
Mesh Model::processMesh(aiMesh * mesh, const aiScene * scene)
{
	...
	return Mesh(vertices, indices, textures, _func);
}
